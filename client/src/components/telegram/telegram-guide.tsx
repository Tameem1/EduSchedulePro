        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700">
              <li>
                قم بتنزيل تطبيق تيليجرام على الهاتف أو استخدم نسخة الويب{" "}
                <a
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="flex flex-col space-y-1.5">
              <label htmlFor="telegramUsername" className="font-medium">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="submit"
                  disabled={
                    updateUserMutation.isPending || !telegramUsername.trim()
                  }
                >
          ...
          <div className="bg-blue-100 p-3 rounded-md text-blue-800 text-sm">
            ...
            <p>
              يجب أن تكون متصلاً بتيليجرام لتتمكن من استلام إشعارات عن المواعيد
              المخصصة لك. سيتم إخطارك عند تعيين موعد جديد.
            </p>
            <p className="mt-2">
              إذا واجهت أي مشكلة في الاتصال بروبوت تيليجرام، يرجى التواصل مع
              مدير النظام للحصول على المساعدة وتفاصيل الروبوت الصحيحة.
            </p>
          </div>
        </div>
      </CardContent>
