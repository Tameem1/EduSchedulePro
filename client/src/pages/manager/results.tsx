...
export default function ManagerResults() {
  ...
  const sampleResponses = [
    ...
    },
    {
      id: 3,
      appointmentId: 4,
      studentName: "إيما طومسون",
      teacherId: 203,
      teacherName: "الدكتور ويليامز",
            ...
            <CardContent>
              {todayResponses.length > 0 ? (
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground">لم يتم تقديم تقارير اليوم</p>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {allDates.length > 0 ? (
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground">لا توجد تقارير سابقة متاحة</p>
                </div>
              )}
            </CardContent>
          </Card>
