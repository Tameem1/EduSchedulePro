    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
          ...
          <Link href="/teacher/independent-questionnaire" className="w-full sm:w-auto">
            <Button 
              variant="outline" 
              className="w-full sm:w-auto flex items-center gap-1 border-green-500 text-green-600 hover:bg-green-50"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 ml-1">
