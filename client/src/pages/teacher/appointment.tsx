...
<div className="grid grid-cols-2 items-center gap-4">
                    ...
                    <div>{appointment.student ? appointment.student.username : `طالب #${appointment.studentId}`}</div>
                  </div>
...
<DialogHeader>
        ...
        <DialogDescription>
          ملء استمارة للطالب {appointment.student ? appointment.student.username : `#${appointment.studentId}`}
        </DialogDescription>
      </DialogHeader>
